...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Empowering Palestinians Financial Ecosystem Through Blockchain Worldwide",
    url: "https://palicoin.uk",
    images: [
      {
        url: "https://gateway.pinata.cloud/ipfs/bafybeiathvy24em7gdmwlxhr2xe76h35ni7l7zeax2xeyrtsp23pcrvrum/palicoin.png",
        alt: "PALI Coin Logo",
      },
    ],
  },
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className="h-full">
      <body className={`${poppins.variable} antialiased h-full flex flex-col`}>
        <div className="flex flex-1 flex-col">
          <Navbar />
          <main className="flex-1">{children}</main>
          <Footer />
